class Game {
  ...
  showLife() {
    push();
    image(lifeImage, width / 2 - 130, height - player.positionY - 275, 20, 20);
    fill("white");
  ...
  showFuelBar() {
    push();
    image(fuelImage, width / 2 - 130, height - player.positionY - 225, 20, 20);
    fill("white");
    rect(width / 2 - 100, height - player.positionY - 225, 185, 20);
    fill("#ffc400");
    rect(width / 2 - 100, height - player.positionY - 225, player.fuel, 20);
    noStroke();
    pop();
  }
  showLeaderboard() {
